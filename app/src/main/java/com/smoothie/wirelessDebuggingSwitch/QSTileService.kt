...
class QSTileService : TileService() {
    ...
    private var adbWifi: AdbWifi? = null
    ...
    override fun onCreate() {
        super.onCreate()
        adbWifi = AdbWifi.getPrivilegeMethod(this)
    ...
    private fun switchState() {
        adbWifi?.let {
            ...
            if (it.getEnabled()) it.syncConnectionData()
        }
    }
    ...
    private fun updateTile() {
        ...
        if (adbWifi?.getEnabled() == true) {
            var label: String
            var message: String

            try {
                label = getString(R.string.qs_tile_label_enabled)
                message = adbWifi?.getConnectionData() ?: getString(R.string.qs_tile_subtitle_no_connection_data)
...
//        val wirelessDebuggingEnabled = adbWifi?.getEnabled() == true
//
...
//
//            val connectionData = adbWifi?.getConnectionData() ?: "Unavailable"
